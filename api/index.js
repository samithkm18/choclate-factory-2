 ...
 * Dynamic import wrapper to capture and report exact runtime errors.
 */
...
async function getApp() {
  ...
  try {
    ...
    // Import DB & routes dynamically
    const { initDb } = await import('../backend/db/database.js');
    const { default: authRouter } = await import('../backend/routes/auth.js');
    const { default: productsRouter } = await import('../backend/routes/products.js');
    const { default: ordersRouter } = await import('../backend/routes/orders.js');
    const { default: ownerRouter } = await import('../backend/routes/owner.js');
    const { default: mwcRouter } = await import('../backend/routes/mwc.js');
    const { default: jobsRouter } = await import('../backend/routes/jobs.js');
    const { default: Setting } = await import('../backend/models/Setting.js');
