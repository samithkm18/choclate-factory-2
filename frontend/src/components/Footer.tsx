...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-brand-darkBg border-t border-brand-maroon/20 pt-16 pb-8 px-6 md:px-12 font-sans text-zinc-400">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
        {/* Brand Information */}
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <h2 className="text-xl font-serif text-brand-gold uppercase tracking-widest font-bold">
              {settings.business_name}
            </h2>
          </div>
          <p className="text-xs italic text-brand-goldLight">"{settings.tagline}"</p>
          <p className="text-xs text-zinc-500 leading-relaxed">
            Crafting raw single-origin cocoa into premium, custom-assembled sensory experiences for true connoisseurs since 2026.
          </p>
          <div className="pt-2">
            <a 
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs">
            <li>
              <Link to="/catalog" className="hover:text-brand-gold transition-colors">Chocolate Catalog</Link>
            </li>
            <li>
              <Link to="/builder" className="hover:text-brand-gold transition-colors">Custom Box Builder</Link>
            </li>
            <li>
              <Link to="/login" className="hover:text-brand-gold transition-colors">Account Management</Link>
            </li>
            <li>
              <Link to="/owner/login" className="hover:text-brand-gold/80 hover:underline flex items-center gap-1 transition-colors">
                Owner Dashboard <ExternalLink size={10} />
              </Link>
            </li>
            <li>
              <Link to="/mwc/login" className="hover:text-brand-gold/80 hover:underline flex items-center gap-1 transition-colors">
                MWC Developer <ExternalLink size={10} />
              </Link>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-zinc-600">
        <p>© 2026 {settings.business_name}. All rights reserved. Custom box configurations are trademarked.</p>
