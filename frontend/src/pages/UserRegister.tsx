    ...
    <div className="max-w-md mx-auto py-32 px-6 font-sans text-white">
      <div className="bg-brand-panelBg border border-brand-maroon/20 rounded-3xl p-8 space-y-6 shadow-2xl relative">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-2xl md:text-3xl font-serif text-brand-goldLight uppercase font-semibold">GUEST REGISTER</h2>
          <p className="text-xs text-zinc-400">Join our reservation circle for bespoke chocolates.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          <div>
            <label className="block text-[10px] text-zinc-400 uppercase tracking-wider mb-1">Your Full Name</label>
            <div className="relative">
              ...
              />
              <User className="absolute left-3 top-3.5 text-zinc-500" size={14} />
            </div>
          </div>
          ...
          >
            {loading ? 'Creating account...' : <><LogIn size={14} /> Create Bespoke Account</>}
          </button>
        </form>
        ...
        <div className="text-center border-t border-brand-maroon/10 pt-4 text-xs text-zinc-500">
          ...
          <Link to="/login" className="text-brand-gold hover:underline font-semibold flex items-center justify-center gap-1 mt-1">
